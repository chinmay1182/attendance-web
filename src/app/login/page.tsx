            ...
            <div className={styles.formSide}>
                <div className={styles.card}>
                    ...
                    <p className={styles.terms} style={{ marginTop: '24px' }}>
                        By continuing, you agree to our <Link href="/terms-of-use" className={styles.link} style={{ marginLeft: 0 }}>Terms of Service</Link> and <Link href="/privacy-policy" className={styles.link} style={{ marginLeft: 0 }}>Privacy Policy</Link>.
                    </p>
                </div>
            </div>
        </div>
